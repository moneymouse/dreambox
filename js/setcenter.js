...
$("#searchbox").on("click",function(e){
    $(".click_work").toggleClass("work","true");
    $(".click_work").children().toggleClass("work","true");
    $(".result").on("click",function(){
        $(".result").toggleClass("point");
        $("#searchbox").val($(".result").text());
        $(".click_work").removeClass("work");
        $(".click_work").children().removeClass("work");
        $(".result").removeClass("point");
    })
})